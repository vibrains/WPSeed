...
<?php /*
	 ...
	 */?>
	 ...
	 <div class="tribe-events-schedule tribe-clearfix">
	 	<i class="fa fa-clock-o" aria-hidden="true" style="float: left;"></i>&nbsp;<?php echo tribe_events_event_schedule_details( $event_id, '<h2>', '</h2>' ); ?>
	 	...
	 	<div class="tbd-container" style="float: left;">
	 		...
	 		<p style="margin: 0; margin-top: -5px; margin-left: 5px;">Event date TBD</p>

	 		<style type="text/css">h2 span, .dtstart{
	 			display:none;
	 		}</style>
